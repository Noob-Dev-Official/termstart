...
const COMM_ls = {
	...
	usage: 'ls',
	longdesc:
		'Lists all added "bookmarks"<br>you can open open added links if you<br> click them, or with open "name"',
};
...
const COMM_add = {
	...
	usage: 'add "name" "url"',
	longdesc:
		'Add a site to your "bookmarks"<br>after adding a site you can <br>list, open or delete them',
};
...
const COMM_theme = {
	...
	longdesc:
		'Change the colors of termstart, <br>you can list all available <br>themes with the command themes',
};
...
const COMM_themes = {
	...
	usage: 'themes',
	longdesc:
		'Lists all available themes, <br>you can apply one of them with<br> the command theme "theme-name"',
};
